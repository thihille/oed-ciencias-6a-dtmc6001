...
$(window).load(function(e){
  ...
  var quantidadeImagens = localStorage.length;
	var quantidadeAudios = localStorage.length;
	var loadimagens = new Array (
    "img/akpalo_quadro_creditos_divisa.png",
    "img/akpalo_quadro_rodape.png",
    "img/akpalo_textura_ciencias.png",
    "img/akpalo_textura_geografia.png",
    "img/akpalo_textura_historia.png",
    "img/akpalo_textura_matematica.png",
    "img/akpalo_textura_portugues.png",
    "img/alpha000.png",
    "img/bg_creditos.png",
    ...
    "img/favicon.ico",
    "img/img_btn_ico1.png",
    "img/img_btn_ico1b.png",
    "img/img_btn_ico2.png",
    "img/img_btn_ico2b.png",
    "img/img_btn_ico3.png",
    "img/img_btn_ico3b.png",
    "img/loader.gif",
    "img/logotipo_ebsa_creditos.jpg",
    "img/praticando_capa_logotipo.png",
    "img/praticando_fundo_body.png",
    "img/praticando_instrucoes_btn_fechar.png",
    "img/praticando_instrucoes_guia_aba.png",
    "img/praticando_logotipo_ebsa_creditos.png",
    "img/sprite_sheet_akpalo.png",
    "img/sprite_sheet_akpalo_logo.png",
    "img/sprite_sheet_apoema.png",
    "img/abertura-animation.jpg",
		"media/audio/abertura.mp3"
	);
  ...
  if(localStorage.getItem('audios0')){
    for(var i = 0; i < quantidadeImagens; i++){
      console.log('Preload de áudio '+localStorage.getItem('audios'+i)+' carregado!');
      loadimagens.push('conteudo/'+localStorage.getItem('audios'+i));
    }
  }else{
    console.log('Desenvolvedor, não existe audio para preload, se puder insira no game.html ;)');
  }
    ...
    if(CONFIG[0].abertura){
      ...
      if(CONFIG[0].abertura == 'sim'){
        ...
        var abertura = new Howl({urls: ['media/audio/abertura.mp3']});

        // ABERTURA
        $("#loading").fadeOut(1000, function(){
          $("#loading").remove();
          $('.abertura').fadeIn(1000).addClass('playAbertura');
          abertura.play();
        });

        setTimeout(function(){
          $('.abertura').fadeOut(1000);


          setTimeout(function(){
            for(var i = 0; i < quantidadeImagens; i++){
              localStorage.removeItem('imagens'+i);
            }

            if(CONFIG[0].infoOed.template == 'praticando'){
              animacao_entrada_capa_praticando();
            }else if(CONFIG[0].infoOed.template == 'tempo'){
              animacao_entrada_capa_tempo();
            }else{
